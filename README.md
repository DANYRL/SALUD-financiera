# HACKATHON: "Salud Financiera"

## PLANEACIÓN DEL PROYECTO

El proyecto fue dividido en las siguientes fases:

1. Investigación acerca de la cultura financiera en México entre los jóvenes. 
2. Elaboración y aplicación de encuestas a estudiantes de Laboratoria para saber cuáles son sus necesidades.
3. Planteamiento de la historia de usuario a partir de lo recolectado en las encuestas.
4. Ideación de los problemas a resolver con nuestra aplicación. 
5. Elaboración de prototipo de baja fidelidad con base en una lluvia de ideas. 
6. Elaboración de prototipo de alta fidelidad.
7. Modificación de prototipo de alta fidelidad, a partir del feedback recibido por expertos.  
8. Cración de la interfaz.

Las primeras 6 etapas, fueron programadas para llevarse a cabo durante las primeras 24 horas del proyecto.
De este modo, proyectamos el tiempo suficiente para aplicarlo a la creación de la interfaz en en las siguientes 36 horas restantes. 

## ASIGNACIÓN DE TAREAS

Previo a la presentación del README, el squad tuvo la oportunidad de conocerse e identificar para que track se pretendían postular, por lo que fue más sencillo el asignar las actividades de UX a Fabiola y Daniela, mientras que FE fueron asignadas a Brenda y Alicia. Sin embargo, la sinergia del grupo fue de mucha colaboración, por lo que todas las involucradas participaron en mayor o menor medida en alguna parte del proyecto. 
...
### Tu mayor ventaja, el tiempo: Sensibilización para iniciar el ahorro ya!!!

De acuerdo con el sitio Finanzas para todos, “El tiempo es el mejor aliado del inversor. Es algo valioso que no se puede vender ni comprar y, una vez agotado, ya no se puede recuperar”. Aquí un comparativo de ahorro en diferentes edades:

Paola es una joven de 20 años que ha decidido ahorrar e invierte $6,000 cada año con interés anual del 4%. Al cabo de 10 años, deja de realizar aportaciones porque prefiere disponer del dinero para otras cosas, pero deja todo lo que ha invertido acumulando intereses todos los años.
